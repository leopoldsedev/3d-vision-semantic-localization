...
gps_local_full = gps_full_data_Full[:,8:11]
...
limits = get_lim_equal_scaling_3d(np.hstack([gps_x_6, gps_x_7, gps_x_8, gps_x_10, gps_x_15, gps_x_full]), np.hstack([gps_y_6, gps_y_7, gps_y_8, gps_y_10, gps_y_15, gps_y_full]), np.hstack([gps_z_6, gps_z_7, gps_z_8, gps_z_10, gps_z_15, gps_z_full]))
